    ...
    !function (a) {
        ...
        var b, c = "function" == typeof define && define.amd, d = function (b) {
            ...
            this.stylePara = function (b, c) {
                ...
                var e = a(k.isText(c.sc) ? c.sc.parentNode : c.sc), f = ["font-family", "font-size", "text-align", "list-style-type", "line-height"], g = b(e, f) || {};
            ...
            this.insertOrderedList = function () {
                ...
                var d = h.head(b), e = h.last(b), f = k.isList(d.previousSibling) && d.previousSibling, g = k.isList(e.nextSibling) && e.nextSibling, i = f || k.insertAfter(k.create(c || "UL"), e);
            ...
            this.fontSize = function (b, d) {
                ...
                if (b) {
                    ...
                    -1 !== d && c.deleteData(d, 1), k.isEmpty(b) && k.remove(b), a.removeData(u)
                }
        ...
        var D = function (a) {
            ...
            var b = function (b) {
                ...
                var g = h.head(c.items), i = "file" === g.kind && -1 !== g.type.indexOf("image/");
            ...
            var d = {
                ...
                if (e.length) {
                    var f, g = e.attr("data-event"), i = e.attr("data-value"), l = e.attr("data-hide"), m = k.makeLayoutInfo(c.target);
                    if (-1 !== a.inArray(g, ["resize", "floatMe", "removeMedia", "imageShape"])) {
                        var n = m.handle().find(".note-control-selection");
                        f = a(n.data("target"))
                    }
                    if (l && e.parents(".popover").hide(), a.isFunction(a.summernote.pluginEvents[g]))a.summernote.pluginEvents[g](c, b.editor, m, i); else if (b.editor[g]) {
                        var o = m.editable();
            ...
            this.bindKeyMap = function (c, e) {
                ...
                var d = c.airMode ? a.popover() : a.toolbar(), g = d.find(".note-dimension-picker-mousecatcher");
                g.css({
            ...
            var b = function (a, b) {
                ...
                picture: function (a, b) {
                    return c(b.iconPrefix + "picture-o", {event: "showImageDialog", title: a.image.image, hide: !0})
                }, link: function (a, b) {
                    ...
                    return b(e, {title: a.font.size, dropdown: '<ul class="dropdown-menu note-check">' + d + "</ul>"})
                }, color: function (a, c) {
                    ...
                    return c(b.iconPrefix + "align-left", {title: a.paragraph.paragraph, dropdown: j})
                }, height: function (a, b) {
            ...
            this.createLayoutByAirMode = function (b, c) {
                ...
                var g = !b.is(":disabled"), l = a('<div class="note-editable" contentEditable="' + g + '"></div>').prependTo(e);
        ...
        a.extend(a.summernote, {
            ...
            summernote: function () {
                ...
                if (e = a.extend({}, a.summernote.options, e), e.langInfo = a.extend(!0, {}, a.summernote.lang["en-US"], a.summernote.lang[e.lang]), !c && d)for (var f = 0, g = a.summernote.plugins.length; g > f; f++) {
